...
define config.name = _("Manon_s professional adventure")
...
define build.name = "Manon_sprofessionaladventure"
...
define config.save_directory = "Manon_sprofessionaladventure-1723383465"
